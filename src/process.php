...
switch ($function) {
	...
	case ('send'):
		...
		if (($message) != "\n") {
			...
			"<div class='d-flex flex-row justify-content-start mb-4'><img src='" . $_SESSION['imagemPerfil'] . "' alt='" . $_SESSION['email'] . "' style='width: 45px; height: 100%; border-radius: 25px;'><div class='p-3 ms-3' style='border-radius: 15px; background-color: " . $rgba . "; max-width: 310px !important;'><p class='small mb-0' style='color: #000;'><b style='color: " . $rgb . "'>" .  $nickname . "</b><br>" . $message = str_replace("\n", " ", $message) . "</p></div></div>\n");
